    ...
    <main class="main-container bg-[#FFF9EF] text-[#3B2A21] overflow-hidden">
        ...
        <footer class="bg-[#554840] text-[#FFF9EF] text-center pt-[12%] pb-[8%] px-[5%] w-full box-border mt-20 relative">
            ...
            <div class="pt-[18%] relative z-30">
                <a href="https://iuthaguenau.unistra.fr" target="_blank" rel="noopener noreferrer" class="bg-[#7A4A32] hover:bg-[#65412a] transition-all duration-200 px-[5%] py-3 mb-6 text-sm font-medium shadow-lg mx-auto block tracking-wide rounded-t-[2rem] rounded-b-lg inline-block">
                    Site de l'IUT
                </a>
                ...
                <div class="flex justify-center gap-4 mb-4 w-[150px] mx-auto relative z-10">
                    <a href="https://www.instagram.com/iuthaguenau/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="w-10 h-10 bg-[#7A4A32] hover:bg-[#65412a] rounded-full flex items-center justify-center transition-all duration-200 shadow-md active:scale-95 group">
                    ...
                    <a href="https://www.facebook.com/iuthaguenau" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="w-10 h-10 bg-[#7A4A32] hover:bg-[#65412a] rounded-full flex items-center justify-center transition-all duration-200 shadow-md active:scale-95 group">
                        <svg class="w-5 h-5 text-[#FFF9EF] group-hover:text-[#ABDDCC]" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                    </a>
                    <a href="https://www.youtube.com/channel/UCCWhIbKffSxu6wEMPQV0R_w" target="_blank" rel="noopener noreferrer" aria-label="YouTube" class="w-10 h-10 bg-[#7A4A32] hover:bg-[#65412a] rounded-full flex items-center justify-center transition-all duration-200 shadow-md active:scale-95 group">
                        <svg class="w-5 h-5 text-[#FFF9EF] group-hover:text-[#ABDDCC]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex justify-center gap-4 text-lg underline mb-24">
                    <a href="{{ route('mentions-legales') }}" class="hover:text-white/80 transition-colors duration-200">Mentions légales</a>
                </div>
            </div>
