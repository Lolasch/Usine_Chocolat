            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6" aria-label="Formulaire d'inscription">
                ...
                <div class="flex flex-col space-y-4 mt-8">
                    ...
                    <div class="flex justify-center">
                        <button type="submit" class="bg-[#FCE097] rounded-t-[2rem] rounded-b-3xl p-4 transition-all transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-[#FCE097]/50" aria-label="S'inscrire">
