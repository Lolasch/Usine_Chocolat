...
return [
    ...
    */
    ...
    'gt' => [
        ...
        'file' => 'Le fichier :attribute doit être plus grand que :value kilobytes.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Le :attribute fourni a été compromis dans une fuite de données. Veuillez choisir un :attribute différent.',
    ],
    ...
    */
    ...
    | with something more reader friendly such as E-Mail instead of "email".
    | This simply helps us make our error messages a little more expressive.
    |
    */
